    ...
    <el-drawer
      ...
      <div class="demo-drawer__content">
        <el-card @close="isEdit = false" class="InfoCard" custom-class="custom-dialog"
          ...
          <h3 class="register-title" style="margin-left:330px;margin-top: 10px;font-size: 30px">工作人员信息管理</h3>
          <el-form ref="form" :rules="rulesForm" :model="form" label-width="90px" >
            ...
            <el-row>
              ...
              <el-col :span="5">
                <el-form-item>
                  <el-button type="primary" v-on:click="SaveEmployeeEdit('form')" style="width: 100px; margin-left: 400px" >保 存</el-button>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
